...
export type SadbPageSubstate =
  (typeof SadbPageSubstate)[keyof typeof SadbPageSubstate];

export class SadbPageSubstateMachine
  extends PageSubstateMachine<SadbPageSubstate> {
  constructor() {
